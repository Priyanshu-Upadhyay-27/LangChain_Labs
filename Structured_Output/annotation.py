...
class prod_feedback(BaseModel):
    ...
    Pros: Annotated[Optional[list[str]], "Suggest the pros of the product"]
    Cons: Annotated[Optional[list[str]], "Suggest the cons of the product"]


structured_model = model.with_structured_output(prod_feedback)

result = structured_model.invoke("""I recently upgraded to the Samsung Galaxy S24 Ultra, and I must say, it's an absolute
powerhouse! The Snapdragon 8 Gen 3 processor makes everything lightning fast-whether I'm gaming, multitasking, or editing 
photos. The 5000mAh battery easily lasts a full day even with heavy use, and the 45W fast charging is a lifesaver.
...
Expensive compared to competitors 1""")
